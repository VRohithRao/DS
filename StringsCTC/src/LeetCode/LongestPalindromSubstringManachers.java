...
public class LongestPalindromSubstringManachers {
    ...
    public LongestPalindromSubstringManachers(String s) {
        this.s = s;
        preprocess();
        p = new int[t.length];
    ...
    public static void main(String[] args) {
        String s = "abccbabacbca";
        LongestPalindromSubstringManachers manacher = new LongestPalindromSubstringManachers(s);
