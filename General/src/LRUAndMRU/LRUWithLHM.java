...
*/
public LRUWithLHM (int cacheSize) {
   ...
   map = new LinkedHashMap<K,V>(hashTableCapacity, hashTableLoadFactor, true) {
      ...
      @Override protected boolean removeEldestEntry (Map.Entry<K,V> eldest) {
         return size() > LRUWithLHM.this.cacheSize; }}; }
...
public static void main (String[] args) {
	LRUWithLHM<String,String> c = new LRUWithLHM<String, String>(3);
	   c.put ("1", "one");                           // 1
	   c.put ("2", "two");                           // 2 1
	   c.put ("3", "three");                         // 3 2 1
	   c.put ("4", "four");                          // 4 3 2
